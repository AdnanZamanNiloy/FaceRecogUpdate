...
class Login_System:
    def __init__(self, root):
        ...
        img = Image.open(r"F:\Desktop\Face Recognation Project\Face_Recog_Images\synthetic-data-scaled.jpg")
        ...
        img1 = Image.open(r"F:\Desktop\Face Recognation Project\Face_Recog_Images\profile_6914786.png")
        ...
        img3 = Image.open(r"F:\Desktop\Face Recognation Project\Face_Recog_Images\photo_2024-12-12_17-12-28-removebg-preview.png")
        ...
        img2 = Image.open(r"F:\Desktop\Face Recognation Project\Face_Recog_Images\key_11410394.png")
    ...
    def login(self):
        ...
        #     self.app = Face_Recognition_System(self.new_window)
            ...
            conn = mysql.connector.connect(host="localhost", user="root", password="19521971", database="face_recognizer")
...
class Register:
    def __init__(self, root):
        ...
        # Background Image
        self.image = ImageTk.PhotoImage(file="F:\Desktop\Face Recognation Project\Face_Recog_Images\synthetic-data-scaled.jpg")
        bg_img = Label(self.root, image=self.image)
        bg_img.place(x=0, y=0, width=1530, height=790)
        
        # Left image
        self.left = ImageTk.PhotoImage(file="F:\Desktop\Face Recognation Project\Face_Recog_Images\photo_2024-12-12_13-15-26.jpg")
